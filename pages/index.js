      ...
      <main id="content" role="main" className="main commerce-listing">
        ...
        <section className="commerce-listing-content mx-auto flex flex-wrap pb4">
          ...
          <div className="col-12 md-col-7 pt2 pb3 md-px4 md-pt1 md-pb7">
            <div
              className="md-commerce-header relative md-flex flex-wrap items-center md-mx0 md-mb2"
              style={{textAlignLast:"center"}}
            >
              <h1 className="h3 mb2 md-mt2 md-mb2 md-ml0 flex-auto px2" style={{ display: "inline-flex", justifyContent:"center" }}>A <span> <div className="h3 mb2 md-mt2 md-mb2 md-ml0 px2" style={{ display: "inline-flex", color:"green" }}>D <span> <div className="h3 mb2 md-mt2 md-mb2 md-ml0 px2" style={{ display: "inline-flex",  color:"orange"  }} >O <span> <div className="h3 mb2 md-mt2 md-mb2 md-ml0 px2" style={{ display: "inline-flex",  color:"hotpink"  }}>R  <span> <div className="h3 mb2 md-mt2 md-mb2 md-ml0 px2" style={{color:"blue"}}>E </div> </span> </div> </span> </div> </span> </div> </span></h1>
              ...
              <div>
                ...
                >
                  <div className="flex flex-column justify-between">
                    <div>
                      <h2 className="commerce-listing-product-name h6" style={{textAlign: "center"}}> Soothing <b style={{color:"green"}}> Green </b> </h2>
                    </div>
